  ...
  return (
    <div className="mb-8 relative z-10">
      <div className="flex justify-between items-center mb-4">
        <div 
          onClick={() => !isLoadingFeatures && fileInputRef.current?.click()}
          className={`flex-1 flex items-center justify-center p-6 border-2 border-dashed border-white/20 rounded-lg ${
            isLoadingFeatures ? 'cursor-not-allowed opacity-50' : 'cursor-pointer hover:border-white/40'
        ...
        <button
          ...
          className="p-6 border-2 border-white/20 rounded-lg hover:border-white/40 transition-colors bg-black/20 backdrop-blur-sm"
        >
